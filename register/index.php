...
<head>
    ...
    <title>J2R Library Center - Register</title>
    ...
    <div class="container-fluid position-absolute h-100" style="background:#F0E2D0;">
        <div class="row h-100">
            <div class="col-8 d-flex justify-content-center align-items-center flex-column" style="background-image:url('../assets/img/background-1.png');background-repeat:no-repeat;background-position:center;background-size:cover;">
                <h1 class="display-1 m-0 fw-bolder text-center text-white mb-4" style="text-shadow:-2px -2px 0 black, 2px -2px 0 black, -2px 2px 0 black, 2px 2px 0 black;">Welcome</h1>
            ...
            <div class="col-4 px-5">
                <form action="" method="post" class="w-100 h-100 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <h1 class="fw-semibold mt-3 mb-5">Register</h1>
                    ...
                    <div class="input-group input-group-lg mb-5">
                        <span class="input-group-text" style="width:55px;">
                            <i class="fa-solid fa-key mx-auto"></i>
                        </span>
                        <input type="password" name="confirm-password" class="form-control fw-bold" placeholder="Confirm password" autocomplete="off" required>
                    </div>
                    <button type="submit" class="btn btn-lg btn-primary fw-bold w-50 mb-4">Register</button>
                    <p class="text-center fw-semibold m-0">Have already an account? Please <a href="../login/" class="link link-primary">login</a></p>
                </form>
            </div>
        </div>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body py-5">
                        ...
                        <h5 class="text-center fw-semibold m-0">
                            <?php 
                                if($status == 1){
                                    echo "Selamat, Anda telah membuat akun baru!";
                                }elseif($status == 2){
                                    echo "Maaf, password Anda tidak sesuai!";
                                }elseif($status == 3){
                                    echo "Maaf, akun Anda telah ada sebelumnya!";
                                }
                            ?>
                        </h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-lg btn-danger fw-bold w-25" data-bs-dismiss="modal" onclick="<?= ($status == 1) ? "location.href='../login'" : ""; ?>">Close</button>
                    </div>
                </div>
            </div>
        </div>
